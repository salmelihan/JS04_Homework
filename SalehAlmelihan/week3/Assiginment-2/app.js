...
let car = {
    ...
    model: "",
    year: 0,
    driver: function(){console.log("Driving")},
    brake: function(){console.log("brake")},
    park: function(){console.log("park")}
}
car.driver();
car.brake();
car.park();
...
pet_owner = {
    name:"Adam",
    address:  {number:7878, street:"Ismail Alghali",suburb:"Olaya", city:"Riyadh"},
}
// Answer Ends Here
...
// Answer Starts Here
 some_pet = function (name, species, breed, noise) {
  ...
  some_pet.prototype.makeNoise = function () {
    return this.noise;
  }
